 ...
 * JsltEditor
 *
 * An instance of CodeMirror for editing a Jslt transformation value to be passed with the GraphQL request.
 *
 * Props:
 *
 ...
 *
 */
export class JsltEditor extends React.Component<JsltEditorProps> {
  CodeMirror: any;
  editor: (CM.Editor & { options: any; showHint: any }) | null = null;
  cachedValue: string;
  private _node: HTMLElement | null = null;
  ignoreChangeEvent: boolean = false;
  constructor(props: JsltEditorProps) {
    super(props);
  ...
  componentDidUpdate(prevProps: JsltEditorProps) {
    this.CodeMirror = require('codemirror');
    if (!this.editor) {
      return;
    }
